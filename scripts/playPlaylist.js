...
if(vP == "hls"){player = document.getElementById('curPlaying');}
  ...
  document.getElementById("vjsP").lang = localStorage.getItem("lang"); 
player = videojs('vjsP');

//used for picture in picture functionaily
document.getElementById("vjsP").addEventListener('enterpictureinpicture', () => {
...
function playC(url, indexP){
  ...
  else if(vP == "vjs"){document.getElementById('vjsP').style.display = '';}
...
document.addEventListener("fullscreenchange", function() {
  ...
  if (!document.fullscreen) {
    ...
    else if(vP == "vjs"){document.getElementById('vjsP').style.display = 'none'; player.hide(); player.pause();}
